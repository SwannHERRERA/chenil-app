...
export class initDB1615420938128 implements MigrationInterface {
    name = 'initDB1615420938128'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "move" ("moveId" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "haveSynergie" boolean NOT NULL, "damage" integer NOT NULL, "stamina" integer NOT NULL, "hold" integer NOT NULL, "priority" real NOT NULL, "class" integer NOT NULL, "Target" integer NOT NULL, "synergieMoveSynergieId" uuid, "parentMoveMoveSynergieId" uuid, CONSTRAINT "PK_9cf37e1209d3e3c05dc55dccbc4" PRIMARY KEY ("moveId"))`);
